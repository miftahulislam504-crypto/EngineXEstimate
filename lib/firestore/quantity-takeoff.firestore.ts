...
//
// পাথ:
//   projects/{projectId}/estimatingInput/quantityTakeoffs/{importId}  ← প্রতিটা import স্থায়ীভাবে সংরক্ষিত
...
export async function getActiveQuantityTakeoff(
  ...
  const importRef = doc(db, 'projects', projectId, PARENT_COLLECTION, IMPORTS_SUBCOLLECTION, importId)
...
export async function getQuantityTakeoffHistory(
  ...
  const importsRef = collection(db, 'projects', projectId, PARENT_COLLECTION, IMPORTS_SUBCOLLECTION)
